            ...
            <div class="card-body">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-6">
                        <div class="dropdown float-right mb-4">
                            <button class="btn btn-success dropdown-toggle" type="button" data-toggle="dropdown">Harga Termahal
                ...
                <?php if (!empty($setor)) : ?>
                    <table class="table text-white">
                        <thead>
                            <tr> <a href="<?= base_url('setor/cetakHargaTermahal'); ?>"><button type="button" class="btn btn-light mb-4 float-right">Cetak</button></a></tr>
                            <tr>
                                <th scope="col">#</th>
